...
function generateCSS(height, width, color) {
  const obj = { height: height, width: width, color: color};
  return obj;
 // obj.height = height;
 // obj.width = width;
 // obj.color = color;
...
console.log(getValue({ name: 'Ally', age: 27, job: 'hypnotist' }));
...
console.log(wrapAround(['teaspoon', 'meat grinder', 'spatula', 'salad fork']));
